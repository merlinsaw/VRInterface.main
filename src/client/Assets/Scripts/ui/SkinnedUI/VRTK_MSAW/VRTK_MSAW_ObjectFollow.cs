...
namespace VRTK
{
    ...
    /// </summary>
    public abstract class VRTK_MSAW_ObjectFollow : MonoBehaviour
    {
        ...
        [Tooltip("Limit the Axis that are effected")]
        public Vector3 axisEffectedPosition = new Vector3(1,1,1);
        [Tooltip("Offset the the position to the given game object.")]
        ...
        {
            gameObjectToChange.transform.localScale = newScale + offsetScale;
        }
        ...
        protected virtual void FollowPosition()
        {
            ...
            SetPositionOnGameObject(Vector3.Scale(newPosition, axisEffectedPosition) + offsetPosition);
        }
        ...
        protected virtual void FollowRotation()
        {
            ...
            SetRotationOnGameObject(newRotation * offsetRotation);
        }
