...
//	{
//	  if (mListener == null || !GUITools.GetActive(mListener))
//	  {
...
//		  {
//			if (GUITools.GetActive(listeners[i]))
//			{
...
//	  if (mListener != null && mListener.enabled && GUITools.GetActive(mListener.gameObject))
//	  {
...
//	UIRoot root = (trans != null) ? GUITools.FindInParents<UIRoot>(trans.gameObject) : null;
...
//	if (root == null)
//	{
//	  GameObject go = GUITools.AddChild(null, false);
...
//	  Camera[] cameras = GUITools.FindActive<Camera>();
...
//	  Camera cam = GUITools.AddChild<Camera>(root.gameObject, false);
...
//	  AudioListener[] listeners = GUITools.FindActive<AudioListener>();
...
//	  if (GUITools.IsChild(trans, panel.transform))
//	  {
