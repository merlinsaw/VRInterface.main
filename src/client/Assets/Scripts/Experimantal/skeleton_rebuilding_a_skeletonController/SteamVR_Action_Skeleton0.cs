...
namespace Valve.VR.o
{
    ...
    /// </summary>
    public class SteamVR_Action_Skeleton0 : SteamVR_Action_Pose_Base<SteamVR_Action_Skeleton_Source_Map0, SteamVR_Action_Skeleton_Source0>, ISteamVR_Action_Skeleton_Source0, ISerializationCallbackReceiver
    {
        public const int numBones = 31;

        public delegate void ActiveChangeHandler(SteamVR_Action_Skeleton0 fromAction, bool active);
        public delegate void ChangeHandler(SteamVR_Action_Skeleton0 fromAction);
        public delegate void UpdateHandler(SteamVR_Action_Skeleton0 fromAction);
        public delegate void TrackingChangeHandler(SteamVR_Action_Skeleton0 fromAction, ETrackingResult trackingState);
        public delegate void ValidPoseChangeHandler(SteamVR_Action_Skeleton0 fromAction, bool validPose);
        public delegate void DeviceConnectedChangeHandler(SteamVR_Action_Skeleton0 fromAction, bool deviceConnected);
        ...
        public SteamVR_Action_Skeleton0() { }
        ...
        /// <returns>0-1 value. 0 being straight, 1 being fully curled.</returns>
        public float GetFingerCurl(SteamVR_Skeleton_FingerIndexEnum0 finger)
        {
        ...
        /// <returns>0-1 value. 0 being no gap, 1 being "full" gap</returns>
        public float GetSplay(SteamVR_Skeleton_FingerSplayIndexEnum0 fingerSplay)
        {
        ...
        /// <param name="finger">The finger to return a curl value for</param>
        /// <returns>0-1 value. 0 being straight, 1 being fully curled.</returns>
        public float GetLastFingerCurl(SteamVR_Skeleton_FingerIndexEnum0 finger)
        {
        ...
        /// <param name="fingerGapIndex">The finger gap to return a splay value for. </param>
        /// <returns>0-1 value. 0 being no gap, 1 being "full" gap</returns>
        public float GetLastSplay(SteamVR_Skeleton_FingerSplayIndexEnum0 fingerSplay)
        {
    ...
    public class SteamVR_Action_Skeleton_Source_Map0 : SteamVR_Action_Pose_Source_Map<SteamVR_Action_Skeleton_Source0>
    {
        protected override SteamVR_Action_Skeleton_Source0 GetSourceElementForIndexer(SteamVR_Input_Sources inputSource)
        {
    ...
    /// For more information check out this blog post: https://steamcommunity.com/games/250820/announcements/detail/1690421280625220068
    /// </summary>
    public class SteamVR_Action_Skeleton_Source0 : SteamVR_Action_Pose_Source, ISteamVR_Action_Skeleton_Source0
    {
        protected static uint skeletonActionData_size = 0;

        /// <summary>Event fires when the active state (ActionSet active and binding active) changes</summary>
        public new event SteamVR_Action_Skeleton0.ActiveChangeHandler onActiveChange;

        /// <summary>Event fires when the active state of the binding changes</summary>
        public new event SteamVR_Action_Skeleton0.ActiveChangeHandler onActiveBindingChange;

        /// <summary>Event fires when the orientation of the pose or bones changes more than the changeTolerance</summary>
        public new event SteamVR_Action_Skeleton0.ChangeHandler onChange;

        /// <summary>Event fires when the action is updated</summary>
        public new event SteamVR_Action_Skeleton0.UpdateHandler onUpdate;

        /// <summary>Event fires when the state of the tracking system that is used to create pose data (position, rotation, etc) changes</summary>
        public new event SteamVR_Action_Skeleton0.TrackingChangeHandler onTrackingChanged;

        /// <summary>Event fires when the state of the pose data retrieved for this action changes validity (good/bad data from the tracking source)</summary>
        public new event SteamVR_Action_Skeleton0.ValidPoseChangeHandler onValidPoseChanged;

        /// <summary>Event fires when the device bound to this action is connected or disconnected</summary>
        public new event SteamVR_Action_Skeleton0.DeviceConnectedChangeHandler onDeviceConnectedChanged;
        ...
        /// <summary>A 0-1 value representing how curled the thumb is. 0 being straight, 1 being fully curled.</summary>
        public float thumbCurl { get { return fingerCurls[SteamVR_Skeleton_FingerIndexes0.thumb]; } }

        /// <summary>A 0-1 value representing how curled the index finger is. 0 being straight, 1 being fully curled.</summary>
        public float indexCurl { get { return fingerCurls[SteamVR_Skeleton_FingerIndexes0.index]; } }

        /// <summary>A 0-1 value representing how curled the middle finger is. 0 being straight, 1 being fully curled.</summary>
        public float middleCurl { get { return fingerCurls[SteamVR_Skeleton_FingerIndexes0.middle]; } }

        /// <summary>A 0-1 value representing how curled the ring finger is. 0 being straight, 1 being fully curled.</summary>
        public float ringCurl { get { return fingerCurls[SteamVR_Skeleton_FingerIndexes0.ring]; } }

        /// <summary>A 0-1 value representing how curled the pinky finger is. 0 being straight, 1 being fully curled.</summary>
        public float pinkyCurl { get { return fingerCurls[SteamVR_Skeleton_FingerIndexes0.pinky]; } }


        /// <summary>A 0-1 value representing the size of the gap between the thumb and index fingers</summary>
        public float thumbIndexSplay { get { return fingerSplays[SteamVR_Skeleton_FingerSplayIndexes0.thumbIndex]; } }

        /// <summary>A 0-1 value representing the size of the gap between the index and middle fingers</summary>
        public float indexMiddleSplay { get { return fingerSplays[SteamVR_Skeleton_FingerSplayIndexes0.indexMiddle]; } }

        /// <summary>A 0-1 value representing the size of the gap between the middle and ring fingers</summary>
        public float middleRingSplay { get { return fingerSplays[SteamVR_Skeleton_FingerSplayIndexes0.middleRing]; } }

        /// <summary>A 0-1 value representing the size of the gap between the ring and pinky fingers</summary>
        public float ringPinkySplay { get { return fingerSplays[SteamVR_Skeleton_FingerSplayIndexes0.ringPinky]; } }


        /// <summary>[Previous Update] A 0-1 value representing how curled the thumb is. 0 being straight, 1 being fully curled.</summary>
        public float lastThumbCurl { get { return lastFingerCurls[SteamVR_Skeleton_FingerIndexes0.thumb]; } }

        /// <summary>[Previous Update] A 0-1 value representing how curled the index finger is. 0 being straight, 1 being fully curled.</summary>
        public float lastIndexCurl { get { return lastFingerCurls[SteamVR_Skeleton_FingerIndexes0.index]; } }

        /// <summary>[Previous Update] A 0-1 value representing how curled the middle finger is. 0 being straight, 1 being fully curled.</summary>
        public float lastMiddleCurl { get { return lastFingerCurls[SteamVR_Skeleton_FingerIndexes0.middle]; } }

        /// <summary>[Previous Update] A 0-1 value representing how curled the ring finger is. 0 being straight, 1 being fully curled.</summary>
        public float lastRingCurl { get { return lastFingerCurls[SteamVR_Skeleton_FingerIndexes0.ring]; } }

        /// <summary>[Previous Update] A 0-1 value representing how curled the pinky finger is. 0 being straight, 1 being fully curled.</summary>
        public float lastPinkyCurl { get { return lastFingerCurls[SteamVR_Skeleton_FingerIndexes0.pinky]; } }


        /// <summary>[Previous Update] A 0-1 value representing the size of the gap between the thumb and index fingers</summary>
        public float lastThumbIndexSplay { get { return lastFingerSplays[SteamVR_Skeleton_FingerSplayIndexes0.thumbIndex]; } }

        /// <summary>[Previous Update] A 0-1 value representing the size of the gap between the index and middle fingers</summary>
        public float lastIndexMiddleSplay { get { return lastFingerSplays[SteamVR_Skeleton_FingerSplayIndexes0.indexMiddle]; } }

        /// <summary>[Previous Update] A 0-1 value representing the size of the gap between the middle and ring fingers</summary>
        public float lastMiddleRingSplay { get { return lastFingerSplays[SteamVR_Skeleton_FingerSplayIndexes0.middleRing]; } }

        /// <summary>[Previous Update] A 0-1 value representing the size of the gap between the ring and pinky fingers</summary>
        public float lastRingPinkySplay { get { return lastFingerSplays[SteamVR_Skeleton_FingerSplayIndexes0.ringPinky]; } }
        ...
        protected SteamVR_Action_Skeleton0 skeletonAction;

        protected VRBoneTransform_t[] tempBoneTransforms = new VRBoneTransform_t[SteamVR_Action_Skeleton0.numBones];
        ...
        public override void Preinitialize(SteamVR_Action wrappingAction, SteamVR_Input_Sources forInputSource)
        {
            ...
            skeletonAction = (SteamVR_Action_Skeleton0)wrappingAction;

            bonePositions = new Vector3[SteamVR_Action_Skeleton0.numBones];
            lastBonePositions = new Vector3[SteamVR_Action_Skeleton0.numBones];
            boneRotations = new Quaternion[SteamVR_Action_Skeleton0.numBones];
            lastBoneRotations = new Quaternion[SteamVR_Action_Skeleton0.numBones];

            rangeOfMotion = EVRSkeletalMotionRange.WithController;
            skeletalTransformSpace = EVRSkeletalTransformSpace.Parent;

            fingerCurls = new float[SteamVR_Skeleton_FingerIndexes0.enumArray.Length];
            fingerSplays = new float[SteamVR_Skeleton_FingerSplayIndexes0.enumArray.Length];

            lastFingerCurls = new float[SteamVR_Skeleton_FingerIndexes0.enumArray.Length];
            lastFingerSplays = new float[SteamVR_Skeleton_FingerSplayIndexes0.enumArray.Length];
        }
        ...
        public override void UpdateValue(bool skipStateAndEventUpdates)
        {
            ...
            for (int boneIndex = 0; boneIndex < SteamVR_Action_Skeleton0.numBones; boneIndex++)
            {
                lastBonePositions[boneIndex] = bonePositions[boneIndex];
                lastBoneRotations[boneIndex] = boneRotations[boneIndex];
            }

            for (int fingerIndex = 0; fingerIndex < SteamVR_Skeleton_FingerIndexes0.enumArray.Length; fingerIndex++)
            {
                lastFingerCurls[fingerIndex] = fingerCurls[fingerIndex];
            }

            for (int fingerIndex = 0; fingerIndex < SteamVR_Skeleton_FingerSplayIndexes0.enumArray.Length; fingerIndex++)
            {
            ...
            if (active)
            {
                ...
                boneRotations[0] = SteamVR_Action_Skeleton0.steamVRFixUpRotation * boneRotations[0];
            }
    ...
    public interface ISteamVR_Action_Skeleton_Source0
    {
        /// <summary>
        /// Get the accuracy level of the skeletal tracking data. 
        /// <para/>* Estimated: Body part location can’t be directly determined by the device. Any skeletal pose provided by the device is estimated based on the active buttons, triggers, joysticks, or other input sensors. Examples include the Vive Controller and gamepads.
    ...
    // TODO: @skeleton: add fullbody joints
    /// <summary>The order of the joints that SteamVR Skeleton Input is expecting.</summary>
    public static class SteamVR_Skeleton_JointIndexes0
    {
    ...
    public enum SteamVR_Skeleton_JointIndexEnum0
    {
        root = SteamVR_Skeleton_JointIndexes0.root,
        wrist = SteamVR_Skeleton_JointIndexes0.wrist,
        thumbMetacarpal = SteamVR_Skeleton_JointIndexes0.thumbMetacarpal,
        thumbProximal = SteamVR_Skeleton_JointIndexes0.thumbProximal,
        thumbMiddle = SteamVR_Skeleton_JointIndexes0.thumbMiddle,
        thumbDistal = SteamVR_Skeleton_JointIndexes0.thumbDistal,
        thumbTip = SteamVR_Skeleton_JointIndexes0.thumbTip,
        indexMetacarpal = SteamVR_Skeleton_JointIndexes0.indexMetacarpal,
        indexProximal = SteamVR_Skeleton_JointIndexes0.indexProximal,
        indexMiddle = SteamVR_Skeleton_JointIndexes0.indexMiddle,
        indexDistal = SteamVR_Skeleton_JointIndexes0.indexDistal,
        indexTip = SteamVR_Skeleton_JointIndexes0.indexTip,
        middleMetacarpal = SteamVR_Skeleton_JointIndexes0.middleMetacarpal,
        middleProximal = SteamVR_Skeleton_JointIndexes0.middleProximal,
        middleMiddle = SteamVR_Skeleton_JointIndexes0.middleMiddle,
        middleDistal = SteamVR_Skeleton_JointIndexes0.middleDistal,
        middleTip = SteamVR_Skeleton_JointIndexes0.middleTip,
        ringMetacarpal = SteamVR_Skeleton_JointIndexes0.ringMetacarpal,
        ringProximal = SteamVR_Skeleton_JointIndexes0.ringProximal,
        ringMiddle = SteamVR_Skeleton_JointIndexes0.ringMiddle,
        ringDistal = SteamVR_Skeleton_JointIndexes0.ringDistal,
        ringTip = SteamVR_Skeleton_JointIndexes0.ringTip,
        pinkyMetacarpal = SteamVR_Skeleton_JointIndexes0.pinkyMetacarpal,
        pinkyProximal = SteamVR_Skeleton_JointIndexes0.pinkyProximal,
        pinkyMiddle = SteamVR_Skeleton_JointIndexes0.pinkyMiddle,
        pinkyDistal = SteamVR_Skeleton_JointIndexes0.pinkyDistal,
        pinkyTip = SteamVR_Skeleton_JointIndexes0.pinkyTip,
        thumbAux = SteamVR_Skeleton_JointIndexes0.thumbAux,
        indexAux = SteamVR_Skeleton_JointIndexes0.indexAux,
        middleAux = SteamVR_Skeleton_JointIndexes0.middleAux,
        ringAux = SteamVR_Skeleton_JointIndexes0.ringAux,
        pinkyAux = SteamVR_Skeleton_JointIndexes0.pinkyAux,
    }

    // TODO: @skeleton: add arm indexes
    /// <summary>The order of the fingers that SteamVR Skeleton Input outputs</summary>
    public class SteamVR_Skeleton_FingerIndexes0
    {
        ...
        public static SteamVR_Skeleton_FingerIndexEnum0[] enumArray = (SteamVR_Skeleton_FingerIndexEnum0[])System.Enum.GetValues(typeof(SteamVR_Skeleton_FingerIndexEnum0));
    }

    /// <summary>The order of the fingerSplays that SteamVR Skeleton Input outputs</summary>
    public class SteamVR_Skeleton_FingerSplayIndexes0
    {
        ...
        public static SteamVR_Skeleton_FingerSplayIndexEnum0[] enumArray = (SteamVR_Skeleton_FingerSplayIndexEnum0[])System.Enum.GetValues(typeof(SteamVR_Skeleton_FingerSplayIndexEnum0));
    }

    public enum SteamVR_Skeleton_FingerSplayIndexEnum0
    {
        thumbIndex = SteamVR_Skeleton_FingerSplayIndexes0.thumbIndex,
        indexMiddle = SteamVR_Skeleton_FingerSplayIndexes0.indexMiddle,
        middleRing = SteamVR_Skeleton_FingerSplayIndexes0.middleRing,
        ringPinky = SteamVR_Skeleton_FingerSplayIndexes0.ringPinky,
    }

    public enum SteamVR_Skeleton_FingerIndexEnum0
    {
        thumb = SteamVR_Skeleton_FingerIndexes0.thumb,
        index = SteamVR_Skeleton_FingerIndexes0.index,
        middle = SteamVR_Skeleton_FingerIndexes0.middle,
        ring = SteamVR_Skeleton_FingerIndexes0.ring,
        pinky = SteamVR_Skeleton_FingerIndexes0.pinky,
    }
}