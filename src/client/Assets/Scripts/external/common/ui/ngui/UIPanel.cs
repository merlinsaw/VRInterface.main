...
//[ExecuteInEditMode]
//[AddComponentMenu("UI/NGUI Panel")]
...
//	  while (p != null)
//	  {
//		if (p.mClipping == UIDrawCall.Clipping.SoftClip)
//		  ++count;
//		p = p.mParentPanel;
//	  }
//	  return count;
...
//	mParentPanel = (parent != null) ? GUITools.FindInParents<UIPanel>(parent.gameObject) : null;
//  }
...
//	{
//	  mLayer = mGo.layer;
//	  GUITools.SetChildLayer(cachedTransform, mLayer);
//	  ResetAnchors();
...
//  {
//	UIPanel panel = GUITools.FindInParents<UIPanel>(trans);
//	if (panel != null)
//	  return panel;
//	return createIfMissing ? GUITools.CreateUI(trans, false, layer) : null;
//  }
...
//  {
//	UIRoot rt = root;
//	Vector2 size = GUITools.screenSize;
//	if (rt != null)
...
//	bool isUsingThisPanel = (go != null) && (GUITools.FindInParents<UIPanel>(go) == this);
