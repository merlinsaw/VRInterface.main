...
namespace VRTK
{
    ...
    /// </remarks>
    [AddComponentMenu("Custom UI/Interactions/Interactables/VRTK_MSAW_ObjectTouchAutoInteract")]
    public class VRTK_MSAW_ObjectTouchAutoInteract : VRTK_InteractableListener
    {
        /// <summary>
