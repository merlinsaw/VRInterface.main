...
{
    public class SteamVR_Behaviour_Skeleton0 : MonoBehaviour
    {
        ...
        public SteamVR_Action_Skeleton0 skeletonAction;
        ...
        public float thumbCurl { get { return skeletonAction.GetFingerCurl(SteamVR_Skeleton_FingerIndexEnum0.thumb); } }

        /// <summary>An 0-1 value representing how curled a finger is. 0 being straight, 1 being fully curled.</summary>
        public float indexCurl { get { return skeletonAction.GetFingerCurl(SteamVR_Skeleton_FingerIndexEnum0.index); } }

        /// <summary>An 0-1 value representing how curled a finger is. 0 being straight, 1 being fully curled.</summary>
        public float middleCurl { get { return skeletonAction.GetFingerCurl(SteamVR_Skeleton_FingerIndexEnum0.middle); } }

        /// <summary>An 0-1 value representing how curled a finger is. 0 being straight, 1 being fully curled.</summary>
        public float ringCurl { get { return skeletonAction.GetFingerCurl(SteamVR_Skeleton_FingerIndexEnum0.ring); } }

        /// <summary>An 0-1 value representing how curled a finger is. 0 being straight, 1 being fully curled.</summary>
        public float pinkyCurl { get { return skeletonAction.GetFingerCurl(SteamVR_Skeleton_FingerIndexEnum0.pinky); } }


        public Transform root { get { return bones[SteamVR_Skeleton_JointIndexes0.root]; } }
        public Transform wrist { get { return bones[SteamVR_Skeleton_JointIndexes0.wrist]; } }
        public Transform indexMetacarpal { get { return bones[SteamVR_Skeleton_JointIndexes0.indexMetacarpal]; } }
        public Transform indexProximal { get { return bones[SteamVR_Skeleton_JointIndexes0.indexProximal]; } }
        public Transform indexMiddle { get { return bones[SteamVR_Skeleton_JointIndexes0.indexMiddle]; } }
        public Transform indexDistal { get { return bones[SteamVR_Skeleton_JointIndexes0.indexDistal]; } }
        public Transform indexTip { get { return bones[SteamVR_Skeleton_JointIndexes0.indexTip]; } }
        public Transform middleMetacarpal { get { return bones[SteamVR_Skeleton_JointIndexes0.middleMetacarpal]; } }
        public Transform middleProximal { get { return bones[SteamVR_Skeleton_JointIndexes0.middleProximal]; } }
        public Transform middleMiddle { get { return bones[SteamVR_Skeleton_JointIndexes0.middleMiddle]; } }
        public Transform middleDistal { get { return bones[SteamVR_Skeleton_JointIndexes0.middleDistal]; } }
        public Transform middleTip { get { return bones[SteamVR_Skeleton_JointIndexes0.middleTip]; } }
        public Transform pinkyMetacarpal { get { return bones[SteamVR_Skeleton_JointIndexes0.pinkyMetacarpal]; } }
        public Transform pinkyProximal { get { return bones[SteamVR_Skeleton_JointIndexes0.pinkyProximal]; } }
        public Transform pinkyMiddle { get { return bones[SteamVR_Skeleton_JointIndexes0.pinkyMiddle]; } }
        public Transform pinkyDistal { get { return bones[SteamVR_Skeleton_JointIndexes0.pinkyDistal]; } }
        public Transform pinkyTip { get { return bones[SteamVR_Skeleton_JointIndexes0.pinkyTip]; } }
        public Transform ringMetacarpal { get { return bones[SteamVR_Skeleton_JointIndexes0.ringMetacarpal]; } }
        public Transform ringProximal { get { return bones[SteamVR_Skeleton_JointIndexes0.ringProximal]; } }
        public Transform ringMiddle { get { return bones[SteamVR_Skeleton_JointIndexes0.ringMiddle]; } }
        public Transform ringDistal { get { return bones[SteamVR_Skeleton_JointIndexes0.ringDistal]; } }
        public Transform ringTip { get { return bones[SteamVR_Skeleton_JointIndexes0.ringTip]; } }
        public Transform thumbMetacarpal { get { return bones[SteamVR_Skeleton_JointIndexes0.thumbMetacarpal]; } } //doesn't exist - mapped to proximal
        public Transform thumbProximal { get { return bones[SteamVR_Skeleton_JointIndexes0.thumbProximal]; } }
        public Transform thumbMiddle { get { return bones[SteamVR_Skeleton_JointIndexes0.thumbMiddle]; } }
        public Transform thumbDistal { get { return bones[SteamVR_Skeleton_JointIndexes0.thumbDistal]; } }
        public Transform thumbTip { get { return bones[SteamVR_Skeleton_JointIndexes0.thumbTip]; } }
        public Transform thumbAux { get { return bones[SteamVR_Skeleton_JointIndexes0.thumbAux]; } }
        public Transform indexAux { get { return bones[SteamVR_Skeleton_JointIndexes0.indexAux]; } }
        public Transform middleAux { get { return bones[SteamVR_Skeleton_JointIndexes0.middleAux]; } }
        public Transform ringAux { get { return bones[SteamVR_Skeleton_JointIndexes0.ringAux]; } }
        public Transform pinkyAux { get { return bones[SteamVR_Skeleton_JointIndexes0.pinkyAux]; } }
        ...
        /// </summary>
        /// <param name="overTime">How long you want the blend to take (in seconds)</param>
        public void BlendToPoser(SteamVR_Skeleton_Poser0 poser, float overTime = 0.1f)
        {
            if (poser == null)
                return;
        ...
        protected Vector3[] GetBonePositions()
        {
            ...
            if (mirroring == MirrorType.LeftToRight || mirroring == MirrorType.RightToLeft)
            {
                ...
                {
                    if (boneIndex == SteamVR_Skeleton_JointIndexes0.wrist || IsMetacarpal(boneIndex))
                    {
                        rawSkeleton[boneIndex].Scale(new Vector3(-1, 1, 1));
                    }
                    else if (boneIndex != SteamVR_Skeleton_JointIndexes0.root)
                    {
        ...
        protected Quaternion[] GetBoneRotations()
        {
            ...
            if (mirroring == MirrorType.LeftToRight || mirroring == MirrorType.RightToLeft)
            {
                for (int boneIndex = 0; boneIndex < rawSkeleton.Length; boneIndex++)
                {
                    if (boneIndex == SteamVR_Skeleton_JointIndexes0.wrist)
                    {
        ...
        {
            return (boneIndex == SteamVR_Skeleton_JointIndexes0.indexMetacarpal ||
                boneIndex == SteamVR_Skeleton_JointIndexes0.middleMetacarpal ||
                boneIndex == SteamVR_Skeleton_JointIndexes0.ringMetacarpal ||
                boneIndex == SteamVR_Skeleton_JointIndexes0.pinkyMetacarpal ||
                boneIndex == SteamVR_Skeleton_JointIndexes0.thumbMetacarpal);
        }
        ...
        public delegate void ActiveChangeHandler0(SteamVR_Behaviour_Skeleton0 fromAction, SteamVR_Input_Sources inputSource, bool active);
        public delegate void ChangeHandler0(SteamVR_Behaviour_Skeleton0 fromAction, SteamVR_Input_Sources inputSource);
        public delegate void UpdateHandler0(SteamVR_Behaviour_Skeleton0 fromAction, SteamVR_Input_Sources inputSource);
        public delegate void TrackingChangeHandler0(SteamVR_Behaviour_Skeleton0 fromAction, SteamVR_Input_Sources inputSource, ETrackingResult trackingState);
        public delegate void ValidPoseChangeHandler0(SteamVR_Behaviour_Skeleton0 fromAction, SteamVR_Input_Sources inputSource, bool validPose);
        public delegate void DeviceConnectedChangeHandler0(SteamVR_Behaviour_Skeleton0 fromAction, SteamVR_Input_Sources inputSource, bool deviceConnected);
    }
}