...
{
    public class SteamVR_Skeleton_Poser0 : MonoBehaviour
    {
        ...
        public SteamVR_Skeleton_Pose0 skeletonMainPose;
        public List<SteamVR_Skeleton_Pose0> skeletonAdditionalPoses = new List<SteamVR_Skeleton_Pose0>();
        ...
        public SteamVR_Skeleton_PoseSnapshot0 blendedSnapshotL;
        public SteamVR_Skeleton_PoseSnapshot0 blendedSnapshotR;

        private SkeletonBlendablePose0[] blendPoses;
        ...
        public SteamVR_Skeleton_Pose0 GetPoseByIndex(int index)
        {
            if (index == 0) { return skeletonMainPose; }
            else { return skeletonAdditionalPoses[index - 1]; }
        }

        private SteamVR_Skeleton_PoseSnapshot0 GetHandSnapshot(SteamVR_Input_Sources inputSource)
        {
        ...
        public SteamVR_Skeleton_PoseSnapshot0 GetBlendedPose(SteamVR_Behaviour_Skeleton0 skeletonBehaviour)
        {
        ...
        /// </summary>
        public class SkeletonBlendablePose0
        {
            public SteamVR_Skeleton_Pose0 pose;
            public SteamVR_Skeleton_PoseSnapshot0 snapshotR;
            public SteamVR_Skeleton_PoseSnapshot0 snapshotL;

            /// <summary>
            /// Get the snapshot of this pose with effects such as additive finger animation applied.
            /// </summary>
            public SteamVR_Skeleton_PoseSnapshot0 GetHandSnapshot(SteamVR_Input_Sources inputSource)
            {
                if (inputSource == SteamVR_Input_Sources.LeftHand)
                {
                    return snapshotL;
        ...
        public class PoseBlendingBehaviour
        {
            ...
            public bool useMask;
            public SteamVR_Skeleton_HandMask0 mask = new SteamVR_Skeleton_HandMask0();
    ...
    /// </summary>
    public class SteamVR_Skeleton_PoseSnapshot0
    {
        ...
        public SteamVR_Skeleton_PoseSnapshot0(int boneCount, SteamVR_Input_Sources source)
        {
            inputSource = source;
    ...
    /// </summary>
    [System.Serializable]
    public class SteamVR_Skeleton_HandMask0
    {
        public bool palm;
        public bool thumb;
        public bool index;
        ...
        public SteamVR_Skeleton_HandMask0()
        {
            values = new bool[6];
            Reset();
        }
        ...
        public static readonly SteamVR_Skeleton_HandMask0 fullMask = new SteamVR_Skeleton_HandMask0();
    };
