...
//	  {
//		Vector2 screen = GUITools.screenSize;
...
//		return adjustByDPI ? GUIMath.AdjustByDPI(height) : height;
//	  }
//	  else
//	  {
...
//  public float pixelSizeAdjustment { get { return GetPixelSizeAdjustment(Mathf.RoundToInt(GUITools.screenSize.y)); } }
...
//  {
//	UIRoot root = GUITools.FindInParents<UIRoot>(go);
...
//	  return (float)minimumHeight / height;
//	if (height > maximumHeight)
//	  return (float)maximumHeight / height;
//	return 1f;
//  }
